...
int main(){
  ...
  while(cin>>lp_1>>lb_1>>lm_1>>lp_2>>lb_2>>lm_2 && !(lp_1==0 || lp_2==0)){
    ...
    if(lm_1>=lb_1 && lp_1>lb_1){ //si pierde más o lo mismo que mete y no es capaz de llenarla de un solo viaje tenemos un problema
       pm_1=1;
       cpt_1=LONG_LONG_MAX;
    }
    ...
    while(pm_1==0){ //comprobacion de que no pierde más o lo mismo que mete (si fuera así pm_1==1)
